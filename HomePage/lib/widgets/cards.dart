  ...
  final card = TextButton(
    ...
    child: Container(
      child: Column(children: <Widget>[
        ClipRRect(
          borderRadius: BorderRadius.circular(20),
          child: Text('Pabloescobar Fortinat EScobar de', style: TextStyle(color: Colors.white)),
        ),
      ]),
    ),
  );
  ...
  final card = TextButton(
    ...
    child: Container(
      child: Column(children: <Widget>[
        ...
        ClipRRect(
          borderRadius: BorderRadius.circular(20),
          child: Text('Frefire Pablito xxdes vs Miguel', style: TextStyle(color: Colors.white),),
  ...
  final card = TextButton(
    ...
    child: Container(
      child: Column(children: <Widget>[
        ClipRRect(
          borderRadius: BorderRadius.circular(20),
          child: Text('MikeProaso Pleyer Camperes', style: TextStyle(color: Colors.white)),
        ),
      ]),
    ),
  );
